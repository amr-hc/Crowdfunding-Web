    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <router-link v-show="isAdmin" v-if="isAuthenticated" class="text-light text-decoration-none"
              to="/dashboard">
              <button class="nav-link" :class="{ active: $route.path.startsWith('/dashboard') }">
