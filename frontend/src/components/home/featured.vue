<template>
    <div class="featured row p-0 m-0  align-items-center">
        <h1 class="col-12 col-lg-3">Our <br> Featured <br>Projects</h1>
...
export default {
    ...
    data() {
        return {
            projects: [
                {
                    imageUrl: 'https://s3.amazonaws.com/ooomf-com-files/wdXqHcTwSTmLuKOGz92L_Landscape.jpg',
                ...
                {
                    imageUrl: 'https://s3.amazonaws.com/ooomf-com-files/mtNrf7oxS4uSxTzMBWfQ_DSC_0043.jpg',
                ...
                {
                    imageUrl: 'https://s3.amazonaws.com/ooomf-com-files/tU3ptNgGSP6U2fE67Gvy_SYDNEY-162.jpg',
    ...
    methods: {
        showSlider(direction) {
            ...
            if (direction === 'next') {
                ...
                listItems.insertBefore(listItems.children[listItems.children.length - 1].cloneNode(true), listItems.children[0]);
                listItems.children[listItems.children.length - 1].remove();

                thumbnails.insertBefore(thumbnails.children[thumbnails.children.length - 1].cloneNode(true), thumbnails.children[0]);
...
.carousel .list .item:nth-child(1) img {
    ...
    bottom: 50px;
    border-radius: 20px;
    animation: showImae .5s linear .5s forwards;
}
...
.carousel.next .thumbnail .item:nth-last-child(1) {
    width: 0;
    overflow: hidden;
    animation: showThumbnail .5s linear .5s forwards;
}
...
.carousel.next .thumbnail {
    ...
    animation: transformThumbnail .5s linear .5s forwards;
}
...
.carousel.prev .list .item:nth-child(2) img {
    ...
    bottom: 0;
    left: 0;
    animation: outImage .5s linear .5s forwards;
}
