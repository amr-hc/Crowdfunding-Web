      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">Edit Project Form</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
             </div>
                        
            <div class="modal-body">
              <form class="row g-3 needs-validation" @submit.prevent="handleFormSubmission" novalidate>
                    <div class="col-md-6">
                      <label for="validationCustom01" class="form-label">id</label>
                      <input v-model="projectId" readonly type="text" class="form-control" 
                ...
                <div class="col-md-6">
                  <label for="validationCustom03" class="form-label">Target Money</label>
                  <input  v-model="targetMoney"
                ...
                <div class="col-md-6">
                    ...
                    pattern="^[a-zA-Z ,.'\-]+$" v-model="category">
                ...
                <div class="col-md-6">
                  <label for="validationCustom06" class="form-label">Project End Date</label>
                  <input v-model="endDate" type="DATE" class="form-control" id="validationCustom06" required>
                  <div class="invalid-feedback">
